...
def home(request):
    ...
    url = f'https://api.openweathermap.org/data/2.5/weather?q={city}&appid=5eb719eaa944e31ed7077e700568f492'
    PARAMS = {'units':'metric'}

    API_KEY =  'AIzaSyC9wAagr-URMnUpfi5OMW27_bA04wVyCC4'

    SEARCH_ENGINE_ID = 'e4f560e41dedc410c'
